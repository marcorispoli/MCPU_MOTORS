...
trxModule::trxModule(void):pd4Nanotec(CONFIG->getParam<uint>(TRX_CANID, 0))
{
...
void trxModule::initializationCompleted(bool result){
    INTERFACE->EVENT_TrxInitCompleted(result);
}
